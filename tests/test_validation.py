from guardian.validation import collect_observed_reason_codes


def test_collect_observed_reason_codes_detects_packet_loss(tmp_path):
    ...
    observed = collect_observed_reason_codes(csv_path)

    assert "PACKET_LOSS" in observed
